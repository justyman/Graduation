...
public class RandomData {
    ...
    public static int cardnum = 5496751;
     ...
     * 随即生成16位信用卡号
     */
    public synchronized static String getCard(){
        String pre = "6258";
        SimpleDateFormat dateFormat = new SimpleDateFormat("ssSSS");
        String lat = dateFormat.format(new Date());
        return pre + cardnum++ + lat;
    }
