...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        data:JSON.stringify({"card":card,"id":id,"channel":channel,"status":"E","deadline":deadline,"pageNum":1,"pageSize":pageSize}),
...
function lastPage() {
    ...
    $.ajax({
        ...
        async:true,
        contentType:"application/json;charset=utf-8",
        data:JSON.stringify({"card":card,"id":id,"channel":channel,"status":"E","deadline":deadline,"pageNum":lastPageNum,"pageSize":pageSize}),
        success:function(data){
            if(data.result === "200"){
                var json = JSON.parse(data.message);
                var list = eval(json.list);
...
function nextPage() {
    ...
    $.ajax({
        ...
        async:true,
        contentType:"application/json;charset=utf-8",
        data:JSON.stringify({"card":card,"id":id,"channel":channel,"status":"E","deadline":deadline,"pageNum":nextPageNum,"pageSize":pageSize}),
        success:function(data){
            if(data.result === "200"){
                var json = JSON.parse(data.message);
                var list = eval(json.list);
